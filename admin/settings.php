...
function barb_security_admin_print_scripts(){
    bp_log("barb_security_admin_print_scripts");
    wp_enqueue_style( 'barb_security_admin_style', plugins_url().'/barbpack-security/css/config.css' );
    wp_enqueue_script( 'barb_security_admin_script', plugins_url().'/barbpack-security/js/config.js', array('jquery'));
}
...
function barb_security_admin_menu() {
    bp_log("barb_security_admin_menu");
    $hook = add_menu_page(
        __('Barb Pack Security Setting', Version::$name),
        __('Barb Pack Security', Version::$name),
...
function barb_security_admin_init(){
    bp_log("barb_security_save_setting");
